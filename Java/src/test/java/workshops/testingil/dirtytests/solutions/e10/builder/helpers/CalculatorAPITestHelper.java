...
public class CalculatorAPITestHelper {
    ...
    public static final String REFERENCE_RESULT_JSON = ".\\src\\test\\resources\\reference_result.json";
    public static final String SEQUENCE_INPUT_FILE = ".\\src\\test\\resources\\sequence_api_data.csv";
    ...
    public String get_display_as_json() {
    ...
    public void post_sequence(String body) {
        client.post()
                .uri(uriBuilder -> uriBuilder
                        .path("/calc/sequence")
                        .build())
    ...
    public void post_sequence_message(SequenceMessage message){
        String body = null;
        try {
            body = messageMapper.writeValueAsString(message);
