...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\GitHub\Presentations\Dirty-Tests-Workshop\pythonProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\GitHub\Presentations\Dirty-Tests-Workshop\pythonProject\Scripts\deactivate.nu'
